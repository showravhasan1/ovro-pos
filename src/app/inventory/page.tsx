...
export default function InventoryPage() {
    ...
    useEffect(() => {
        ...
        // Check URL for filter param (client-side)
        ...
        <div className="min-h-screen bg-zinc-100 dark:bg-black font-sans text-zinc-900 dark:text-zinc-100">
            ...
            <header className="bg-white dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800 px-6 py-4">
                <div className="max-w-7xl mx-auto flex justify-between items-center">
                    <div className="flex items-center gap-4">
                        <Link href="/pos" className="flex items-center gap-2 text-zinc-500 hover:text-blue-600 text-sm font-medium">
            ...
            <main className="max-w-7xl mx-auto p-6">
                ...
                <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <Link href="/inventory?filter=lowstock" className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-4 hover:border-red-300 transition-colors">
